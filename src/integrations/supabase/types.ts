    ...
    Tables: {
      ...
      native_release_approvals: {
        Row: {
          ...
          tested_build_number: number;
          workflow_dispatch_at: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: "native_release_approvals_app_id_fkey";
            columns: ["app_id"];
            isOneToOne: false;
            referencedRelation: "native_apps";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "native_release_approvals_org_id_fkey";
            columns: ["org_id"];
            isOneToOne: false;
            referencedRelation: "organisations";
            referencedColumns: ["id"];
